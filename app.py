...
def analyse():
    if request.method == 'POST':
        ...
        final_ans.append("\n")
        final_ans.append("\\title{Hackistica'23}")
        final_ans.append("\\author{Saurabh, Mayank, Neha, Kanchi}")
        ...
        while(len(a)>0):
            ...
            # While Loop
            if(len(a[0])>=5):
                if(a[0][0]=='w' and a[0][1]=='h' and a[0][2]=='i' and a[0][3]=='l' and a[0][4]=='e'):
            ...
            if((len(a[0])>=3 and a[0][0:3]=="int") or (len(a[0])>=4 and (a[0][0:4]=="long" or a[0][0:4]=="auto" or a[0][0:4]=="char")) or(len(a[0])>=5 and (a[0][0:5]=="float" or a[0][0:5]=="short")) or (len(a[0])>=6 and (a[0][0:6]=="signed" or a[0][0:6]=="double")) or (len(a[0])>=8 and a[0][0:8]=="unsigned")):
                ...
                while(len(a[0])>=4 and (a[0][0:4]=="long" or a[0][0:4]=="auto" or a[0][0:4]=="char")):
                    a[0]=a[0][4:]
                    a[0]=a[0].strip() 
            ...
            statemtent = statemtent.strip()
            temp = statemtent.split("=")
            statemtent = ""
            for x12 in temp:
                statemtent = statemtent + x12 + " $\leftarrow$ "
                
            if(len(statemtent)>=14):
                statemtent = statemtent[:-14]
                
            statemtent = "\\State " + statemtent
            final_ans.append(statemtent)
